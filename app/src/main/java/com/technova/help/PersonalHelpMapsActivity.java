...
public class PersonalHelpMapsActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_help_maps);
...
//        googleMap.setMyLocationEnabled(true);
        ...
        reply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PersonalHelpMapsActivity.this, AllResponses.class)
